...
case "${KERNEL_SCHEDULER:-static}" in
    node_original|node_native|node_scoped|node_fixed|node_lend|node_guarded|node_model|node_tail|node_budget|node_priority|node_reserved|node_elastic|node_stage|node_reclaim|node_selective|node_once|node_phaseaware) cpu_bind=none ;;
esac
