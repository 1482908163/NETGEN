...
NGLIB_API void Ng_AddVolumeElement (Ng_Mesh * mesh, Ng_Volume_Element_Type et, int * pi, int index);
...
// NGLIB_API void My_WriteElmerFormat(Ng_Mesh *mesh, const filesystem::path & filename);
NGLIB_API void My_WriteElmerFormat(Ng_Mesh *write_mesh, const std::filesystem::path & filename);

NGLIB_API void My_WriteOpenFOAMFormat(Ng_Mesh *write_mesh, const std::filesystem::path & filename);
NGLIB_API void My_WriteElmerBound(void *submesh, const std::string boundaryfile);
NGLIB_API bool ispatbound(Ng_Mesh * mesh,int j);
